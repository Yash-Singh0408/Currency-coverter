    ...
    <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
      <div className="w-1/2">
        ...
        <input
          id={amountInputId}
          type="number"
          className="outline-none w-full bg-transparent py-1.5 rounded-lg"
          placeholder="Amount"
...
InputBox.propTypes = {
  ...
  currencyOptions: PropTypes.objectOf(PropTypes.string),  // Now expecting an object for currency code and name
